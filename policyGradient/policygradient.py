...
class PolicyGradient:
    ...
    def train(self, feature, action, reward):
        with tf.GradientTape() as tape:
            ...
            loss = tf.multiply(self.losser(action, action_, ), tf.cast(reward, dtype=tf.float32))
    ...
    def learn(self):
        ...
        s, a, r = tf.convert_to_tensor(self.mem_features), tf.convert_to_tensor(self.mem_actions), tf.convert_to_tensor(
            self.mem_rewards)
        print(s, a, r)
        self.train(s, a, r)
